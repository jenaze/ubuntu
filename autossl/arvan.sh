...
echo
blue  "==================================================="
blue  "           BP Auto Wildcard Tool"
blue  "==================================================="
echo  " Automated wildcard SSL for Marzban / Marzneshin / Custom"
echo  " Using: acme.sh  +  Arvan DNS  +  Let's Encrypt"
echo
echo

# ---- Step 1: Get Arvan credentials ----
echo "[Step 1/6] Arvan credentials"
read -rsp "Enter your Arvan API Token: " ARVAN_TOKEN
echo
if [[ -z "$ARVAN_TOKEN" ]]; then
  red "ERROR: Arvan API Token cannot be empty."
  exit 1
fi
echo
...
echo
yellow "Important:"
echo "  - The domain MUST exist in your Arvan account."
echo "  - The domain's nameservers MUST point to Arvan."
echo
press_enter
...
if ! "$ACME_SH" --issue \
  ...
  echo "  - The domain is NOT in your Arvan account."
  echo "  - The nameservers are NOT pointing to Arvan."
  echo "  - Arvan API Token is incorrect."
  echo
...
echo
blue  "==================================================="
blue  "         BP Wildcard Setup Summary"
blue  "==================================================="
echo
